...
class ChangeModel(Base):
    ...
    previous_observed_at: Mapped[datetime | None] = mapped_column(UTCDateTime, nullable=True)
    ...
    current_observed_at: Mapped[datetime] = mapped_column(UTCDateTime, nullable=False)
